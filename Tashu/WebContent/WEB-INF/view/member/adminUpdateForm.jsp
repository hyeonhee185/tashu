...
%>
   ...
   <form class="form-horizontal"  method="post" action="<%=request.getContextPath() %>/member/adminUpdate.do"> 
		<input type="hidden" name="mem_id" id="mem_id" value="<%=mem.getMem_id()%>">
         ...
         <tr>
         <td>이름</td>
         <td class="form-group">  <input class="form-control" id="name" name="mem_name" value="<%=memvo.getMem_name() %>"><span class="sp"></span></td>
         </tr>
         <tr>
         <td>비밀번호</td>
         <td class="form-group"> <input type="password" class="form-control" id="pass" name="mem_pass" value="<%=memvo.getMem_pass() %>"><span class="sp"></span></td>
         </tr>
         <tr>
         <td>핸드폰</td>
         <td class="form-group"><input class="form-control" id="hp" name="mem_tel" value="<%=memvo.getMem_tel() %>"><span class="sp"></span></td>
         </tr>
         <tr>
         <td>우편번호</td>
         <td>
         <input class="form-control" id="zip" name="mem_zip" value="<%=memvo.getMem_zip() %>">
         ...
         <td> 주소</td>
         <td>
         <input class="form-control" id="add1" name="mem_add1" value="<%=memvo.getMem_add1()%>">
         </td>
         </tr>
         <tr>
         <td> 상세주소</td>
         <td>
          <input class="form-control" id="add2" name="mem_add2" value="<%=memvo.getMem_add2() %>">
         </td>
         </tr>
         </table>
