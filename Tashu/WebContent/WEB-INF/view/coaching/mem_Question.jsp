...
<link rel="stylesheet" href="/Tashu/css/mem_Question.css">
...
$(function(){
	$("#submitBtn").on("click", function(){
		...
		location.href="<%=request.getContextPath()%>/coaching/inserMemAnswer.do?day="+day+"&time="+time+"&area="+area+"&term="+term+"&speed="+speed+"&reason="+reason+""; 
	});
});
</script>
	  ...
	  <div class="subcontents">
	    ...
	    <div id="cont_wrap">
	      <div class="mytashuArea">
	        ...
	        <h2 class="tashu_h4">일반회원 질문페이지<h2>	  
<!-- 				<h2>일반회원, 질문페이지</h2> -->
					<h4>원하는 요일, 시간, 장소를 선택해주세요</h4><br><br>
				
				
				<form method="post" action="<%=request.getContextPath()%>/coaching/inserMemAnswer.do">
				<table border="1">
				<tr>
					<td>
						요일
				...
				<tr>
					...
					<td>
						<input type="radio" name="term" value="8" /> 하루
						<input type="radio" name="term" value="9"  /> 일주일
						<input type="radio" name="term" value="10"  /> 한달<br>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="radio" name="speed" value="11" /> 천천히
						<input type="radio" name="speed" value="12"/> 보통
						<input type="radio" name="speed" value="13" /> 빨리<br>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="radio" name="reason" value="14" /> 취미
						<input type="radio" name="reason" value="15" /> 건강
						<input type="radio" name="reason" value="16"/> 대회<br>
					</td>
				</tr>
				<tr>
