...
$(function(){
   ...
   $('#return').on('click', function(){
      location.href="<%=request.getContextPath()%>/course/redirect.do";
   })
...
<div id="subCont">
   ...
   <form id="writeForm" action="<%=request.getContextPath() %>/course/Insert.do">
      <table border="1">
         <tbody>
            ...
            <tr>
               <td>
               <select>
                     <option id="talk1" value="talk1">전문가코스</option>
                     <option id="talk2" value="talk2">일반코스</option>
                     <option id="talk3" value="talk3">초보자코스</option>
                  </select>
                  </td>
      ...
      <div class ="btn1">
               ...
               <input type="reset" id="cancel" value="작성취소">
