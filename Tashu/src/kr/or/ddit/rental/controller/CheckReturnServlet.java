 ...
 */
@WebServlet("/rental/checkReturn.do")
public class CheckReturnServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (check==null) {
			writer.println("<script>location.replace(\"/Tashu/payment/paymentRent.do\");</script>"); 
		}else{
			writer.println("<script>alert('이미 자전거를 대여하셨습니다.');</script>"); 
